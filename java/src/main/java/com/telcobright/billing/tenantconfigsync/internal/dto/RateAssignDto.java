 ...
 * ignored (unknown-properties are off in the config-manager client's mapper) — which ALSO sidesteps the
 * {@code endPreviousRate:false} Boolean the engine {@code rateassign.EndPreviousRate} (Byte) can't deserialize.
 *
