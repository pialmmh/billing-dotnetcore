// Ported from legacy Models_Mediation/sum_voice_day_02/03.cs + hr_02/03.cs (+ the inheritance partial
// in EntityExtensions/_Summary/sum_voice_.cs, merged here). Concrete summary tables for SG 11 (_02)
// and SG 10 (_03), daily + hourly. Plain override POCOs over AbstractCdrSummary.
#nullable disable
...
namespace MediationModel
{
    ...
    public partial class sum_voice_day_02 : AbstractCdrSummary
    {
    ...
    public partial class sum_voice_day_03 : AbstractCdrSummary
    {
        public override long id { get; set; }
        public override int tup_switchid { get; set; }
        public override int tup_inpartnerid { get; set; }
    ...
    public partial class sum_voice_hr_02 : AbstractCdrSummary
    {
        public override long id { get; set; }
        public override int tup_switchid { get; set; }
        public override int tup_inpartnerid { get; set; }
    ...
    public partial class sum_voice_hr_03 : AbstractCdrSummary
    {
        public override long id { get; set; }
        public override int tup_switchid { get; set; }
        public override int tup_inpartnerid { get; set; }
